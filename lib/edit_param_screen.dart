...
class EditParamScreen extends StatefulWidget {
  ...
  @override
  State<EditParamScreen> createState() => _EditParamScreenState();
}
...
class _EditParamScreenState extends State<EditParamScreen> {
  ...
  void initState() {
    ...
    showLastNote = widget.button.showLastNote;
    _controller.text = widget.button.name;
  }
  ...
  //show dialog caution when DELETE button is tapped
  void _validateAndDelete() async {
    final String alertResult = await showDialog(
      context: context,
      builder: (BuildContext context) => AlertDialog(
          title: const Text('Delete, really?'),
          content: SingleChildScrollView(
            child: ListBody(
              children: const <Widget>[
                Text('All data of parameter you gathered will be deleted.'),
                Text('Are you sure?'),
              ],
            ),
          ),
          ...
          floatingActionButton: Row(
            ...
            children: [
              ...
              FloatingActionButton.extended(
                heroTag: 'mainFAB',
                onPressed: () {
                  buttons.updateButton(widget.button.id, _controller.text,
                      color, showLastNote, icon);
